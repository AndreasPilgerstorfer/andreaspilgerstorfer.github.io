...
$(document).ready(function () {
    ...
    $.getJSON("task/persons.json", function (data) {
    ...
    $("#btnsub").click(function (e) {
        ...
        if ($(clickedTaskHTML).hasClass("done")){
            alert("A Subtask can only be added if the maintask has not been closed !")
        }
        else if(ebene == false){
            alert("Max 3 sublevels allowed");
        }
        else{
    ...
    $("#btnEdit").click(() => {
        ...
        if (clickedTask == null){
            alert("Please mark the task which you would like to edit!");
            return;
        }
